...
int send_out_ip2udp(int lowfd, unsigned char *packet, size_t length, int interface);
...
int resolved_udp_packet(void *b, const void *p, size_t l, struct sockaddr_in *f);
